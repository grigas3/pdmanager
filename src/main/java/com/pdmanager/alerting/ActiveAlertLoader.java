 ...
 */
public class ActiveAlertLoader extends AsyncTaskLoader<Cursor> {
    ...
    public ActiveAlertLoader(Context context, AlertAdapter dbHelper) {
        super(context);
    ...
    public Cursor loadInBackground() {
        ...
        Cursor c = dbHelper.fetchActiveAlerts();
