 ...
 */
public class AccDevDataBuffer extends DataBuffer<AccMData> {
    ...
    public AccDevDataBuffer(long mBuffer, String pfolder, String pfileName) {
    ...
    @Override
    protected void WriteItem(DataOutputStream OutDataWriter, AccMData item) throws Exception {
