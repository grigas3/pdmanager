...
//return true;
    ...
    public int pendingMedication() {
     ...
     //           + " INTEGER,"+ COLUMN_TIME
     //           + " INTEGER,"+ COLUMN_DRUG + " TEXT," + COLUMN_INTAKEDESC + " TEXT)";
        ...
        long exunixTime = System.currentTimeMillis() + 60 * 60*1000;
            ...
            try {
                ...
                if (cursor.getCount() == 0) {
                    ...
                    int id = cursor.getInt(0);
                    Calendar cal1 = Calendar.getInstance();
                    cal1.setTimeInMillis(cursor.getLong(3));
                    SimpleDateFormat sdf = new SimpleDateFormat("HH:mm");
                    String shortTimeStr = sdf.format(cal1.getTime());
                    String message=mContext.getString(R.string.medalertpart1) + " " + cursor.getString(1)+ " " +mContext.getString(R.string.medalertpart2) + " " +shortTimeStr;
