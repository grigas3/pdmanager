 ...
 */
public class PatientChartItemFragment extends BasePDFragment implements PatientChartFragment.OnDestinationSelectedListener {
    ...
    public PatientChartItemFragment() {
