...
public class CustomSeekBar extends SeekBar {
    ...
    public CustomSeekBar(final Context ctx) {
        super(ctx);
        init();
    }

    public CustomSeekBar(final Context ctx, final AttributeSet attrs) {
        super(ctx, attrs);
        init();
    }

    public CustomSeekBar(final Context ctx, final AttributeSet attrs, final int defStyle) {
