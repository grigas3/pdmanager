...
import com.pdmanager.viewmodels.OnEditEndListener;
 ...
 */
public class CreatePatMedOrderFragment extends BasePDFragment implements View.OnClickListener {
    ...
    public CreatePatMedOrderFragment() {
