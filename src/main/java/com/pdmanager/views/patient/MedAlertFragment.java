 ...
 */
public class MedAlertFragment extends SoundFeedbackActivity implements IDirectSendCallback {
    /**
    ...
    private void setUp()
    {
        ...
        mButtonConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cal1.setTime(date1);
                Observation obs = new Observation(1, getPatientCode(), "MED_ADH", cal1.getTimeInMillis());
        ...
        mButtonReject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Calendar cal2 = Calendar.getInstance();
                cal1.setTime(date1);
                Observation obs = new Observation(0, getPatientCode(),"MED_ADH", cal1.getTimeInMillis());
