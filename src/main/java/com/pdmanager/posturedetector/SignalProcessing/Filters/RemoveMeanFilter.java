...
package com.pdmanager.posturedetector.SignalProcessing.Filters;

import com.pdmanager.posturedetector.Core.Interfaces.ISignalProcessor;
...
public class RemoveMeanFilter implements ISignalProcessor {
    ...
    public void applyInPlace(com.pdmanager.posturedetector.Core.Signals.SignalBuffer signal) throws Exception {
    ...
    public void applyTo(com.pdmanager.posturedetector.Core.Signals.SignalBuffer source, com.pdmanager.posturedetector.Core.Signals.SignalBuffer to) throws Exception {
        //TODO ASSERTS
    ...
    public void applyInPlace(com.pdmanager.posturedetector.Core.Signals.SignalCollection signal) throws Exception {
    ...
    public void applyTo(com.pdmanager.posturedetector.Core.Signals.SignalCollection source, com.pdmanager.posturedetector.Core.Signals.SignalCollection to) throws Exception {
