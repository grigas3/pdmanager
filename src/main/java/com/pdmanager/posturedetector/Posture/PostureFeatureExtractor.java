...
import com.pdmanager.posturedetector.Core.Logging;
...
import com.pdmanager.posturedetector.FeatureExtractors.BaseWindowCollectionFeatureExtractor;
...
public class PostureFeatureExtractor extends BaseWindowCollectionFeatureExtractor {
    ...
    private PitchFeatures calculatePitch(com.pdmanager.posturedetector.Core.Signals.SignalCollection signal) throws Exception {
     ...
     */
    public void process(com.pdmanager.posturedetector.Core.Signals.NamedSignalCollection signals) throws Exception {
        try {
            com.pdmanager.posturedetector.Core.Signals.SignalCollection bpFreqSignal;
            bpFreqSignal = signals.get___idx(com.pdmanager.posturedetector.SignalProcessing.SignalDictionary.FiltLowPass30);
