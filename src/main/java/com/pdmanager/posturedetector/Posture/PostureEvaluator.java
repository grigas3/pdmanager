...
import com.pdmanager.posturedetector.Core.Interfaces.IPostureEvaluator;
...
public class PostureEvaluator implements IPostureEvaluator {
     ...
     * @return
     */
    public com.pdmanager.posturedetector.Core.Signals.PostureEvaluation evaluate(Date start, Date end, com.pdmanager.posturedetector.Core.Signals.SignalFeature[] features) throws Exception {
        ...
        return new com.pdmanager.posturedetector.Core.Signals.PostureEvaluation(outcomeLw, 1.0, start, end);
    }
