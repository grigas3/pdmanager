...
import com.pdmanager.posturedetector.SignalProcessing.Filters.FIRFilter;
...
public class PostureSignalProcess extends SignalProcess implements ISignalPreprocessor {
     ...
     */
    public void process(com.pdmanager.posturedetector.Core.Signals.SignalCollection source, NamedSignalCollection signals) throws Exception {
         ...
         */
        SignalCollection bpSignal = signals.get___idx(com.pdmanager.posturedetector.SignalProcessing.SignalDictionary.FiltLowPass30);
        if (bpSignal == null) {
            bpSignal = new com.pdmanager.posturedetector.Core.Signals.SignalCollection(numofSignals, size);
            ...
            signals.set___idx(com.pdmanager.posturedetector.SignalProcessing.SignalDictionary.FiltLowPass30, bpSignal);
        } else {
            bpfirFilterX.applyTo(source.get___idx(0), bpSignal.get___idx(0));
            bpfirFilterY.applyTo(source.get___idx(1), bpSignal.get___idx(1));
            bpfirFilterZ.applyTo(source.get___idx(2), bpSignal.get___idx(2));
