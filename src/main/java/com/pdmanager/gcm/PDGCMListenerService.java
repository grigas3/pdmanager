...
public class PDGCMListenerService extends GcmListenerService {
    ...
    private static final String TAG = "PDGCMListenerService";
     ...
     */
    private void sendNotification(String message, String patientId) {
        Intent intent = new Intent(this, ClinicianActivity.class);
        intent.putExtra(PDApplicationContext.INTENT_PATIENT_CODE, patientId);
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.pdmanager)
                .setContentTitle("PD Manager Message")
