...
public final class Gson {
     ...
     * following settings:
     * <ul>
     * <li>The JSON generated by <Type>toJson</Type> methods is in compact representation. This
     ...
     * field <Type>versionNumber</Type> will be output as <Type>&quot;versionNumber&quot;</Type> in
     * Json. The same rules are applied for mapping incoming Json to the Java classes. You can
     * change this policy through {@link GsonBuilder#setFieldNamingPolicy(FieldNamingPolicy)}.</li>
     * <li>By default, Gson excludes <Type>transient</Type> or <Type>static</Type> fields from
     ...
     * the <Type>getDelegateAdapter</Type> method:
     * <pre> {@code
